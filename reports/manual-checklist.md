...
- [x] Open each latest Newman HTML report and spot-check hostname `127.0.0.1:3000`, case IDs, failures, and timestamps. Automated consistency is already verified; this checkbox is the student's visual confirmation.
- [x] Approve making the GitHub repository public, then verify no secrets/personal email are committed.
...
- [x] Read the prompts/outputs in `reports/ai-audit.md`; confirm they match the Gemini chat and that no private email remains.
