...
- [ ] In **PowerShell** at `E:\HCMUS\Sem9\Software Testing\HW06\HW06-software-testing`, run `npm.cmd run test:api:reset -- --student-id 23127373`, capture a real line `[HW06 pre-request] X-Student-Id: 23127373`, and save it as `evidence/screenshots/09-console-x-student-id-23127373.png`. This anti-cheat evidence must not be AI-generated.
