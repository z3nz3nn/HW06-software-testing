...
const validPng = (relative) => exists(relative)
  && fs.readFileSync(path.join(root, relative)).subarray(0, 8).equals(Buffer.from([0x89, 0x50, 0x4E, 0x47, 0x0D, 0x0A, 0x1A, 0x0A]));
...
record("student console screenshot PNG integrity", validPng("evidence/screenshots/09-console-x-student-id-23127373.png"));
record("Agent Skill diagram PNG integrity", validPng("docs/agent-skill-diagram.png"));
